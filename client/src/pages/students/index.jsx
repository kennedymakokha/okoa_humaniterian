...
function index() {
    ...
    return (
        <>
            <Table isLoading={isLoading} key_column="name" columns={columns} setPopUp={setPopUp} setItem={setItem} setShow={setShow} title="students" data={isSuccess && data !== undefined ? data.results.results
                : []}
