    ...
    return (
        <>
            <div className="flex w-full py-14 flex-col relative z-0  rounded-t-md min-h-[86vh]">
                <div className="flex w-full items-center justify-center  pt-[80px] ">
                    <div className="flex  p-2 w-[50%] flex-col h-[70vh] border">
                    </div>

                    <div className="flex  p-2 w-[50%] flex-col h-[70vh] border">
                        <div className="flex items-center justify-between px-5 mb-2">
                            <h2 className='font-bold text-start underline '>Lab tests Results</h2>
                        </div>

                        {labTests !== undefined && labTests.map((data) => (
                            <div key={data._id} className="flex px-4 w-full mt-2 h-10  items-center justify-between rounded-md">
