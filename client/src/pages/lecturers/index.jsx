            ...
            {popUp && <Create_Modal
                ...
                body={<div className='gap-y-2 flex w-full flex-col'>
                    ...
                    <div className="flex gap-x-2">
                        ...
                        <SelectContainer key_name="course_name" item label="Course" array={cousrsesSuccess && courses !== undefined ? courses : []} required name="course" value={item.course} handleChange={(e) => {
                            setItem(((prev) => ({
