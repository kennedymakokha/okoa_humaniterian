        ...
        <div className="overflow-x-auto  ">
            <div className="flex w-full min-w-[900px] overflow-hidden items-center p-2 justify-between">
                ...
                {!notdetailed && <div className="flex items-center justify-center gap-x-3 ">
                    ...
                    {!noAdd && <div onClick={() => setPopUp(true)} className='px-4 text-[18px] shadow-2xl  bg-green-500 flex items-center justify-center font-bold text-white rounded-md'>Add</div>}
                </div>}
            </div>
                        ...
                        <tr key={rowIndex} className="even:bg-gray-50 ">
                            ...
                            {!noAction && <td className="py-2 text-start  px-4 border-b border-l border-gray-200  text-gray-800">
                                <div className="flex gap-2 ">
                                    ...
                                    {location.pathname === "/students" && !row.enroled && <div onClick={() => { enrolUser(row); setItem(row) }} className='text-[10px] px-3 border w-1/3  text-purple-500 font-bold flex items-center justify-center rounded-md'>Enroll</div>}
                                </div>
