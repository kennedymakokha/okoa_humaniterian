...
const Table = ({ columns, noAdd, editOnly,otherAction, noAction, notLinkable, enrolUser, data, setFilter, notdetailed, page, title, paginate, filter, isLoading, key_column, setShow, setItem, setPopUp }) => {
